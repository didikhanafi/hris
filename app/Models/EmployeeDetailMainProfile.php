...
class EmployeeDetailMainProfile extends Model
{
    protected $table="employee";
    protected $fillable=['company_id','departements_id','branches_id','employeecode','employee','email','alamat','city','provensi' ,'phone','tempatlahir' ,'tgllahir' ,'gender','statusnikah','tglmasuk' ,'tglkeluar'  ,'statuskontrak' ,'employeestatus','position'];
    use HasFactory;
